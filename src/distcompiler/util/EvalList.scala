...
object EvalList {
  ...
  given instance: (MonoidK[EvalList] & Foldable[EvalList] & Align[EvalList] & StackSafeMonad[EvalList]) =
    new MonoidK[EvalList] with Foldable[EvalList] with Align[EvalList] with StackSafeMonad[EvalList] {
      ...
      def foldRight[A, B](fa: EvalList[A], lb: Eval[B])(f: (A, Eval[B]) => Eval[B]): Eval[B] = {
